...
app = gr.Interface(fn=test_model, inputs="image", outputs=[gr.Textbox(label="Predicted Label"), gr.Number(label="Predicted Probability")],
                                title="AI vs Human Image Detector", description="Upload an image to test if it is generated by AI or not")
app.launch()